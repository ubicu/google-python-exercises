...
def linear_merge(list1, list2):
    # +++your code here+++
    # return sorted(list1+list2) # Not really a linear merge but does the job of merging and sorting
    
    # Put lists in reverse order to use pop()
    list1 = list1[::-1]
    list2 = list2[::-1]
